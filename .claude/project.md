...
- **Expanded Player Overflow Menu**: See `.claude/player-overflow-menu-plan.md` for the plan behind the expanded player's new ⋯ menu — Autoplay, Crossfade and upstream's "Transfer queue" action